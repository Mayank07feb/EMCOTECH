...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('dash_asset/img/fav.png') }}" type="image/x-icon">
    <link rel="stylesheet" href="https://kit-pro.fontawesome.com/releases/v5.12.1/css/pro.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('dash_asset/css/style.css') }}">
...
<body class="bg-gray-100">
    ...
    <div
        ...
        <div class="flex-none w-56 flex flex-row items-center">
            <img src="{{ asset('dash_asset/img/logo.png') }}" class="w-10 flex-none">
            <strong class="capitalize ml-1 flex-1">Emco-Tech</strong>
                ...
                <div class="dropdown relative md:static">
                    ...
                    <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
                        <div class="w-8 h-8 overflow-hidden rounded-full">
                            <img class="w-full h-full object-cover" src="{{ asset('dash_asset/img/user.svg') }}">
                        </div>
                    ...
                    <div
                        ...
                        <a class="flex flex-row items-center justify-start px-4 py-4 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 transition-all duration-300 ease-in-out"
                            ...
                            <div
                                ...
                                <img class="w-full h-full object-cover" src="{{ asset('dash_asset/img/user1.jpg') }}"
                                    alt="">
                            </div>
                        ...
                        <a class="flex flex-row items-center justify-start px-4 py-4 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 transition-all duration-300 ease-in-out"
                            ...
                            <div
                                class="w-10 h-10 rounded-full overflow-hidden mr-3 bg-gray-100 border border-gray-300">
                                <img class="w-full h-full object-cover" src="{{ asset('dash_asset/img/user2.jpg') }}"
                                    alt="">
                            </div>
                        ...
                        <a class="flex flex-row items-center justify-start px-4 py-4 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 transition-all duration-300 ease-in-out"
                            ...
                            <div
                                class="w-10 h-10 rounded-full overflow-hidden mr-3 bg-gray-100 border border-gray-300">
                                <img class="w-full h-full object-cover" src="{{ asset('dash_asset/img/user3.jpg') }}"
                                    alt="">
                            </div>
        ...
        <div id="sideBar"
            ...
            <div class="flex flex-col">
                ...
                <a href="{{ route('blog.index') }}"
                    ...
                    <i class="fad fa-rss text-xs mr-2"></i> <!-- Adjust the icon class as per your preference -->
                    Blog
                </a>
                <!-- end link -->
                ...
                <a href="{{ route('category.index') }}"
                    ...
                    <!-- Adjust the icon class as per your preference -->
                    Categories
                </a>
                <!-- end link -->
                ...
                <a href="{{ route('about.index') }}"
                    class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500 flex items-center">
                    <i class="fad fa-info-circle text-xs mr-2"></i> <!-- About Us icon -->
                    About Us
                </a>
                <!-- end link -->
    ...
    <script src="{{ asset('dash_asset/js/scripts.js') }}"></script>
    <!-- end script -->
